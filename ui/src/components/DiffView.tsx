        ...
        if (org === mod) {
             ...
             output.push(
                <div key={i} className="flex text-ide-mute/50">
                    <div className="w-8 text-right pr-2 select-none border-r border-ide-border/50 text-xs leading-6">{i+1}</div>
            ...
            if (org !== undefined) {
                output.push(
                    <div key={`del-${i}`} className="flex bg-ide-diff-del-bg">
                        <div className="w-8 text-right pr-2 select-none border-r border-ide-border/50 text-xs leading-6 text-ide-diff-del">-</div>
            ...
            if (mod !== undefined) {
                output.push(
                    <div key={`add-${i}`} className="flex bg-ide-diff-add-bg">
                        <div className="w-8 text-right pr-2 select-none border-r border-ide-border/50 text-xs leading-6 text-ide-diff-add">+</div>
                        <div className="pl-2 text-ide-text font-mono text-sm leading-6 whitespace-pre">{mod}</div>
                    </div>
                );
            }
